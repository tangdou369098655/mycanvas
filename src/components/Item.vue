  ...
  <table v-if="treeData.name">
      ...
      >
        <div :class="{node: true, hasMate: treeData.mate}">
          <div class="person" @click="$emit('click-node', treeData)">
            <div class="avat">
              <div class="name">用户名：{{treeData.name}}</div>
              <div>编号：{{treeData.Numbering}}</div>
              <div>
                <div>
                  <span>左</span>
                  <span>右</span>
                ...
                <div>
                  <span>{{treeData.LeftQuantity}}</span>
                  <span>总</span>
                  <span>{{treeData.RightQuantity}}</span>
                </div>
              </div>
            </div>
          </div>
    ...
    <tr v-if="treeData.children && treeData.extend">
      <td
        ...
        class="childLevel"
      >
        <Item :json="children" @click-node="$emit('click-node', $event)" />
      </td>
    </tr>
  </table>
</template>
